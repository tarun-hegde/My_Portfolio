  ...
  return (
    <div name='skills' className='w-full md:h-screen bg-[#000f26] text-gray-300 mb-4 pb-8'>
      ...
      <div className='pb-8'>
        ...
        transition={{ duration: 1 }} className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 pb-8 text-center py-8'>
            {skills.map((skill) => (
                <div className='shadow-md  borderb-4 rounded-md hover:shadow-[#046ab3] hover:scale-110 duration-500'>
